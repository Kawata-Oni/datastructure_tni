...
public class SinglyApp {
	...
	public static void testGet() {
		int i = 2;
		int j = 7;
		System.out.println("Get element index 2 = "+ list1.get(i));
		System.out.println("Get element index 7 = "+ list1.get(j));
	}
	...
	public static void testContains() {
		...
		System.out.println(find2 + (list2.contains(find2)? " found!!" : " not found..."));
	}
